...
function RedeemDealDetails() {
  return (
    <div className='bg-[#F3FCFF] '>
     ...
     <div className='bg-gray-200 p-2'>Remaining Vouchers: 27h</div>
     </div>
     <div className='font-bold text-xl text-black-500 mt-8'>Your Redeemed Deal’s Details</div>
    ...
    <div className='flex  md:gap-10  gap-5 lg:text-xl md:text-sm text-xs justify-center font-semibold'>
      <div className='bg-white px-3  w-44 py-2'>Redeem Date: April 24,2024
      </div>
      <div className='bg-white px-3  w-44 py-2'>Valid Till: 60 minutes</div>
    </div>
    <div className='font-bold text-xl'>Location</div>
    <div className='flex gap-7'>
      <div className='h-52 w-72'><img src={map} alt="" className='w-full h-full' /></div>
      <div className='h-40 w-40'><img src={qr} alt="" className='h-full w-full'/></div>
    
    </div>
      <div className='bg-gray-200 p-2 md:hidden w-[50%]'>Remaining Vouchers: 27h</div>
     </div>
     <div className='space-y-10 hidden md:block mt-10'>
      <div className='xl:w-[520px]  bg-white lg:h-364px  min-w-[300px] min-h-[250px] flex flex-col text-center justify-center items-center space-y-4 '>
        ...
        <div className='px-4'>4 Redemptions left as a free user, upgrade to premium package to enjoy more</div>
        <div>
          <Button className='text-[14px] mx-4 p-3'>Upgrade Now</Button>
        </div>
      </div>
      <div className='xl:w-[520px]  bg-white xl:h-364px  min-w-[300px] min-h-[250px]  flex flex-col text-center justify-center items-center space-y-4'>
        ...
        <div>Please upload or record your video review.</div>
        <div className='flex justify-between p-4'>
          <div><Button  icon='cloud-arrow-up' className='text-[14px] mx-4 p-3'>Upload a video</Button></div>
          <div><Button  icon='video-camera' className='text-[14px] mx-4 p-3'>Record a video</Button></div>
        </div>
      </div>
     </div>
    </div>
