...
const Header = ({ className = "custom-class" }) => {
  ...
  return (
    <header className={className + " " + navbarTypeClass() + " bg-customBlue"}>
      <div
        className={`bg-customBlue app-header md:px-6 px-[15px]  dark:bg-slate-800 shadow-base dark:shadow-base3 text-white
        ${borderSwicthClass()}
             ${
