...
import img from './../../assets/images/merchant/Ellipse 11216.png';
function TopSection() {
  return (
    ...
    <div className='col-span-2 sm:text-start'>
      ...
      <div className='text-center sm:text-start sm:justify-start flex justify-center gap-10 text-xs md:text-[14px]'>
        <div className=' flex items-center gap-3'>Make Us Your Favorite <span className='inline-flex'><Icon icon='heroicons:heart' className='text-blue-600 mx-auto text-sm'/></span></div>
      ...
      <div className='sm:flex hidden gap-4 text-xs md:text-[14px]'>
        <div className=''>Location (dummy text lorem ipsum)</div>
