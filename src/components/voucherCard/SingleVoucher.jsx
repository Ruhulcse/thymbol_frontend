...
function SingleVoucher({ item }) {
    return (
        <div className="lg:h-44 lg:w-[470px] h-[110px] w-[220px] bg-white shadow-lg sm:w-[260px] sm:h-[120px] md:h-[150px] md:w-[330px]">
            <div className="w-full h-full relative">
                ...
                <div className="flex flex-1 items-center px-4 h-full">
                    <div className=" p-4 border-r-4 border border-t-0 border-l-0 border-b-0 border-dotted mr-4">
                        ...
                        <div className="flex justify-between px-2 md:px-2 md:mt-4 mt-2 items-center">
