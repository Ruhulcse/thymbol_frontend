            ...
            <div className="w-full h-full relative">
                ...
                <div className="flex flex-1 items-center px-4 h-full">
                    ...
                    <div className="lg:w-80 lg:h-36 sm:h-24 sm:w-52 h-20 w-44  my-auto lg:p-2">
                        <Link to={`/${link}/${item?._id}`}>
                            <img
                                src={item?.logo?.file_path ?? 'https://media.istockphoto.com/id/1147544807/vector/thumbnail-image-vector-graphic.jpg?s=612x612&w=0&k=20&c=rnCKVbdxqkjlcs3xH87-9gocETqpspHFXu5dIGB4wuM='}
                                alt=""
